...
contract StellartToken {
    ...
    uint256 public totalSupply = 1000000000000000000000000; //1 millon de tokens (24 ceros - 18 decimals = 6 ceros)
    ...
    //Constructor
    constructor() {
        //Cuando lo despliego le asigno todos los tokens a una sola direccion
